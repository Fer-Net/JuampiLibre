...
class Texto():
    def __init__(self,cadena,x,y,color,tamanio):
        self.cadena= cadena
        self.posX= x
        self.posY= y
        self.color= color

        self.defaultFont= pygame.font.Font( "Recursos\\Fuentes\\Halter.ttf", tamanio)#Recursos\\Fuentes\\Halter.ttf
        self.visible = True

        self.fuente = self.defaultFont
        self.texto = self.fuente.render(self.cadena, 1, self.color)
    ...
    def setDimension(self,nro):
        self.fuente = pygame.font.Font( "Recursos\\Fuentes\\Halter.ttf", nro)
        self.texto = self.fuente.render(self.cadena, 1, self.color)


    def rotar(self,angulo):
         self.texto = pygame.transform.rotate(self.texto, angulo)

    def dibujar(self,pantalla):
        pantalla.blit(self.texto , (self.posX,self.posY))


##class Parrafo():
##
##    def __init__(self,cadena,x,y,color,tamanio,longitud):
##        self.cadena= cadena
##        self.posX= x
##        self.posY= y
##        self.color= color
##
##
##        self.defaultFont= pygame.font.Font( "Recursos\\Fuentes\\Halter.ttf", tamanio)
##        self.visible = True
##
##        self.fuente = self.defaultFont
##        self.texto = self.fuente.render(self.cadena, 1, self.color)
